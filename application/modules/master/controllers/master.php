...
// PERLU DIUBAH
	function country_crud($tes){
		...
		$primary_id = $status[0];
		$last_url = 'master/country_crud/0-0';
		if(($cas >= '4') && ($cas !== '7')){
			$last_url = 'master/country_crud/0-4';		
		}
    ...
    function populate_data(){
    	...
    	$res = $this->mdl_content->get_all_data_country();
            ...
            <table id="tbl_data" class="table table-bordered table-striped" style="width:100%;">
              <thead>
                <tr>
                  ...
                  <th style="width:35%;">Nama Negara</th>
