            ...
            <div class="post">
               <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div>
                       <a href="#" onClick="prepare_add_data();" class="btn btn-warning" role="button"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('new').' Negara'; ?></a> 
                      <br><br>
                    </div>     
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group row">
                  <label class="col-sm-2 control-label">Nama Negara</label>
                  <div class="col-sm-9 ">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9 ">
                      <input type="email" class="form-control" placeholder="Kode Negara"  name="a_code" id="a_code">
                  </div>
                </div>
              </div>
            </div>
   ...
   <div class="modal modal-warning fade" id="delete_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    <div class="modal-dialog">
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	         <input type="text" name="a_id_d" id = "a_id_d">
...
<script>
  ...
  function populate_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('master/populate_data')?>",
      data: { 
        id :id,
           },
  ...
  function prepare_edit_data(a){
    ...
    url ="<?php echo site_url('master/data_detail')?>";
    var id = a;
    $.ajax({
      type: "POST",
      url: url,
      ...
      success: function(jsontext){
        ...
        document.getElementById("a_code").value = getData.item.code;
  ...
  function detail_data(){
    ...
    if(new_data == '1'){
      ...
      url ="<?php echo site_url('master/add_data')?>";
    } else {
      var id = $('#a_id').val();
      datas = { 
        id : id,
      ...
      url ="<?php echo site_url('master/edit_data')?>";
    }
  ...
  function delete_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('master/delete_data')?>",
      data: { 
          id :id,
           },
      success: function(html){
