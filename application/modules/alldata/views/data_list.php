        ...
        <div class="tab-content">
          <div class=" <?php if(!isset($tab) || $tab =='activity'){ echo 'active';}?> tab-pane" id="activity">
            <div class="post">
               <div class="row">
                  <div class="col-sm-12">
                      <a href="<?= base_url('alldata/export_data'); ?>" class="btn btn-success btn-xs pull-right" role="button" ><i class="fa fa-download"></i> Unduh Data</a><br><br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form-horizontal" action="<?php echo base_url('alldata/ubah_medical')?>" method="post" enctype="multipart/form-data" role="form">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form-horizontal" action="<?php echo base_url('alldata/ubah_paspor')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form-horizontal" action="<?php echo base_url('alldata/ubah_psj')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-9 ">
                         <select name="status" id="status" class="form-control">
                            <option value='SJ'>Sidik Jari</option>
                          </select>
                        </div>
                  </div>
                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form-horizontal" action="<?php echo base_url('alldata/ubah_sj')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form-horizontal" action="<?php echo base_url('alldata/ubah_ptb')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form-horizontal" action="<?php echo base_url('alldata/ubah_call')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
...
<script>
  ...
  function populate_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('alldata/populate_data')?>",
      data: { 
        id :id,
           },
  ...
  function prepare_edit_data(a){
    ...
    url ="<?php echo site_url('alldata/data_detail')?>";
    var id = a;
    $.ajax({
      type: "POST",
      url: url,
  ...
  function detail_data(){
    ...
    if(new_data == '1'){
      ...
      url ="<?php echo site_url('alldata/add_data')?>";
    } else {
      var id = $('#a_id').val();
      datas = { 
        id : id,
      ...
      url ="<?php echo site_url('alldata/edit_data')?>";
    }
  ...
  function delete_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('pendaftaran/delete_data')?>",
      data: { 
          id :id,
           },
      success: function(html){
