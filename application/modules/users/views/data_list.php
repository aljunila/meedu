        ...
        <div class="modal-body">
            ...
            <div class="row">
              <div class="col-sm-12">
               ...
               <div class="form-group row">
                  <label class="col-sm-2 control-label">Nama Lawyer</label>
                  <div class="col-sm-9 ">
                    <select name="lawyer_id" class="form-control" id="a_lawyer_id">
                      <option>Pilih Lawyer</option>
                    <?php foreach($lawyers as $c){ ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9 ">
                      <select name="a_akses" id ="a_akses" class="form-control" >
                        <option value="">-- Pilih Hak Akses --</option>
                        <?php foreach ($akses as $k) { ?>
                            <option value="<?php echo $k->id; ?>"><?php echo $k->priviledge_name; ?></option>
                        <?php } ?>
                      </select>
                  </div>
                </div>
...
<script>
  ...
  function populate_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('users/populate_data')?>",
      data: { 
        id :id,
           },
  ...
  function prepare_edit_data(a){
    ...
    $.ajax({
      ...
      success: function(jsontext){
        // alert(jsontext);
        var getData = JSON.parse(jsontext);
        document.getElementById("a_lawyer_id").value = getData.item.id;
        document.getElementById("a_akses").value = getData.item.pvg_id;
  ...
  function detail_data(){
    ...
    var a_lawyer_id = document.getElementById("a_lawyer_id").value ;
    var a_akses = document.getElementById("a_akses").value ;

      datas = { 
        lawyer_id : a_lawyer_id,
        akses : a_akses
      };
