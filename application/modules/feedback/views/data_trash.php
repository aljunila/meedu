...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">Kotak Sampah - <?php echo $title; ?></a></li>
...
<section class="content">
      ...
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li <?php if(!isset($tab) || $tab =='activity'){ echo 'class="active"';}?>>
            <a href="#activity" data-toggle="tab">List Data Terhapus</a>
          </li>
        </ul>
  ...
  <!-- MODAL ANNOUNCE DELETE-->
   <div class="modal modal-danger fade" id="deleteData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	         <input type="text" name="a_id_d" id = "a_id_d" style="display: none;" >
	          <p class="error-text">apakah anda yakin ingin menghapus secara permanent <?php echo $title;?> ini ?</p>
	        </div>
...
function populateData(){
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('pegawai/populate_data_deactive')?>",
    data: { 
      id :id,
         },
    success: function(response){
      console.log(response);
	    ...
	    $("#table-data").html(getData.table_data_trash);
    }
  }); 
}

function prepareDeleteData(id){
...
function ajaxDeleteData(){
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('pegawai/delete_permanent_data_ajax')?>",
    data: { 
        id :id,
         },
    success: function(response){
...
function ajaxRestoreData(id){
  var id= id;
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('pegawai/restore_data_ajax')?>",
    data: { 
        id :id,
         },
    success: function(response){
