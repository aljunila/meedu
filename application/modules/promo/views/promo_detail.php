            ...
            <div class="box box-default">
                ...
                <div class="box-body">
					...
					<?php } ?>
                 	...
                 	<?php
						if(isset($new_data)) {
							echo form_open_multipart('promo/add_data','class="form-horizontal" role="form"');
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Kategori Promo</label>
						<div class="col-sm-8">
							<select name="category" class="form-control">
								<?php foreach($category as $c) {
									echo "<option value='".$c->id."'"; if(!isset($new_data)) { if($data->category_id==$c->id) { echo "selected='selected'"; }} echo ">".$c->name."</option>";
								} ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Isi Promo</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="discount" id="discount" <?php if(!isset($new_data)){ echo 'value="'.$data->discount.'"'; } ?> autofocus>
						</div>
					</div>
					<div class="form-group">
