            ...
            <div class="post">
               <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div>
                        <a href="<?php echo site_url('promo/promo_crud/0-1') ?>" class="btn btn-primary " role="button"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('new').' Promo'; ?></a> 
                      <br><br>
                    </div>     
...
<script>
  ...
  function populate_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('promo/populate_data')?>",
      data: { 
        id :id,
           },
  ...
  function delete_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('promo/delete_data')?>",
      data: { 
          id :id,
           },
      success: function(html){
...
function ajaxSendMsg(id){
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('promo/get_school_detail')?>",
    data: { 
      id:id,
         },
    success: function(html){
