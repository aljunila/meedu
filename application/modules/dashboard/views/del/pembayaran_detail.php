	     ...
	     <?php	if(@$status){ ?>
            ...
            <div class="box box-primary " >
                ...
                <div class="box-body" id="divToPrint" >
                 	<?php
                 		if(!isset($status_transaksi)){
							echo form_open_multipart('dashboard/add_transaksi','class="form-horizontal" role="form"');
							$hidden_data_user = array(
								'daftarId' => $daftarId,
								'userId' => $userId,
								'detail'=>json_encode($biaya),
							);
			        ...
			        >
			          <table style="font-size: 13px">
			            <tr>
			              ...
			              <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
			              <td> <input type="text" name="tsNumb" value="<?php echo $profile->psbId.'/'.date('dmYhis')?>" readonly >
			              </td>
			            </tr>
			            ...
			            <tr>
			              ...
			              <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
			              <td> 
			              	<select name="paymentMethode" >
							<?php echo '<option value = "C">Tunai</option>'?>
							<?php echo '<option value = "T">Transfer</option>'?>
							</select>
							</td>
			            </tr>
			            <tr>
			              ...
			              <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
			              <td> 
							<input type="text"  autocomplete="off" placeholder="Tanggal Transaksi" id="dateStartPicker" name="tsDate" value="<?php echo date('m-d-Y'); ?>" >
			              </td>
			            </tr>
