    ...
    <div class="row">
        ...
        <?php } ?>
              ...
              <tr>
                ...
                <td><?php echo $row->yayasan;?></td>
      				  <td><?php echo $row->country;?></td>
      				  <td><?php echo $row->phone;?></td>
                <td><?php if($this->session->userdata('user_group_id')=='-1'){?>
                <a href="<?php echo site_url('institution/group_crud/'.$row->id.'-5'); ?>" rel="tooltip-top" title="Restore Institution">
                  <i class="fa fa-undo "></i>
                </a>&nbsp;&nbsp;
                <a href="#" rel="tooltip-top" title="Delete Permanent">
                  
                  <i class="fa fa-remove" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('institution/group_crud/'.$row->id.'-6'); ?>" onClick="sendimg(this);"></i>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p class="error-text"><i class="fa fa-exclamation-triangle fa-2x"></i>&nbsp;&nbsp;&nbsp;Are you sure you want to permanent delete this Group?</p>
                </div>
