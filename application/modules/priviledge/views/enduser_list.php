      ...
      <div class="box box-warning">
        ...
        <div class="box-body">
          <?php if(!empty($status)){ ?>
				  ...
				  <?php } ?>
          <a href="<?php echo site_url('priviledge/priviledge_crud/0-1') ?>" class="btn btn-warning" role="button"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Input Hak Akses</a><br><br>
          ...
          <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                  ...
                  <td>
  								  <a href="<?php echo site_url('priviledge/priviledge_crud/'.$row->id.'-2'); ?>" rel="tooltip-top" title="Edit">
  									   <i class="fa fa-edit"></i>
  								  </a>&nbsp;&nbsp;
  								  <a href="#" rel="tooltip-top" title="Delete"> 
  									   <i class="fa fa-trash-alt-alt" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('priviledge/priviledge_crud/'.$row->id.'-3'); ?>" onClick="sendimg(this);"></i>
  								  </a>
  								</td>
  							</tr>
  						  <?php } ?>
