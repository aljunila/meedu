              ...
              <div class="col-sm-12">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-9 ">
                      <select name="a_institution" id="a_institution" class="form-control">
...
<script>
  ...
  function populate_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('adminsekolah/populate_data')?>",
      data: { 
        id :id,
           },
  ...
  function prepare_edit_data(a){
    ...
    url ="<?php echo site_url('adminsekolah/data_detail')?>";
    var id = a;
    $.ajax({
      type: "POST",
      url: url,
      ...
      success: function(jsontext){
        ...
        document.getElementById("a_institution").value = getData.item.institution_id;
  ...
  function detail_data(){
    ...
    var a_institution = document.getElementById("a_institution").value ;
    ...
    if(new_data == '1'){
      ...
      url ="<?php echo site_url('adminsekolah/add_data')?>";
    } else {
      var id = $('#a_id').val();
      datas = { 
        id : id,
      ...
      url ="<?php echo site_url('adminsekolah/edit_data')?>";
    }
  ...
  function delete_data(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('adminsekolah/delete_data')?>",
      data: { 
          id :id,
           },
      success: function(html){
