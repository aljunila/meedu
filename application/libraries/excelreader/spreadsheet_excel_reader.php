...
if (!class_exists('OLERead')){
	#require_once(APPPATH.'libraries/oleread.php');		
...
class Spreadsheet_Excel_Reader
{
    ...
    function Spreadsheet_Excel_Reader()
    {
		...
		log_message('debug', 'Excel Reader Class Initialized.');
     ...
     * @access public
     * @param filename
     * @todo return a valid value or false o
     */
...
//WE HACKED THIS BASTARD SO IT WOULD WORK OK.... JUST give us the days ok??NBNBNBNBNBNB
